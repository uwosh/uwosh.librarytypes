...
def setup_product():
    ...
    import uwosh.librarytypes
    zcml.load_config('configure.zcml', uwosh.librarytypes)
    ...
    ztc.installPackage('uwosh.librarytypes')
...
setup_product()
ptc.setupPloneSite(products=['uwosh.librarytypes'])
